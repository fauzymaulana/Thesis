<?php
	...
	$create_table_sessionPesanan1 = "CREATE TABLE sessionpesanan_1(
		id_pesanan1 INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
		id_konsumen1 INT(6) NOT NULL,
		id_invoice1 INT(6) NOT NULL,
		id_layanan1 INT(6) NOT NULL,
	...
	$create_table_sessionPesanan2 = "CREATE TABLE sessionpesanan_2(
		id_pesanan2 INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
		id_konsumen2 INT(6) NOT NULL,
		id_invoice2 INT(6) NOT NULL,
		id_layanan2 INT(6) NOT NULL,
