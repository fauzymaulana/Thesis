...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="stylebuatinvoice.css">
</head>
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="buatinvoice.php">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="datakonsumen.php">
                <i class="ni ni-bullet-list-67 text-default"></i>
                <span class="nav-link-text"><b>Data Konsumen</b></span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="validator.php">
            ...
            <div class="col-lg-6 col-7">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="#">Data Konsumen</a></li>
                </ol>
              </nav>
            </div>
          </div>
              ...
              <div style="overflow-y: auto; text-align: center;">
                <table class="table table-striped" >
                  <thead>
                    <tr>
                      <th><h5><b>No.</b></h5></th>
                      <th><h5><b>Id_Konsumen</b></h5></th>
                      <th><h5><b>Nama Konsumen</b></h5></th>
                      <th><h5><b></b></h5></th>
                      <th><h5><b>No. Telp</b></h5></th>
                      <th><h5><b>Aksi</b></h5></th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <?php 
                    $no = 1;
                    $sql = $db->koneksi->query("SELECT * FROM data_konsumen");
                      ...
                      while ($data = $sql->fetch_array(MYSQLI_ASSOC)) {
                        ...
                        <tr>
                          ...
                          <td><?php echo $data['nama_konsumen'];?><td>
                            ...
                            <td>
                              <a href="processhps.php?id_konsumen=<?=$data['id_konsumen']?>" name="delete" id="delete" onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?')"  class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                              <a href="#" class="btn btn-success btn-sm"><i class="fa fa-print"></i></a>
                            </td>
                          </tr>
